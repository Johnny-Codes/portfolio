  ...
  return (
    <>
      ...
      <p>
        ...
        Psychological Operations Sergeant, I'm excited to embark on a new
      ...
      <p>
        ...
        rare coin businesses. Faced with the limitations of existing solutions,
        I developed my own inventory management system, showcasing my
        proficiency in languages like Python, JavaScript, React, and TypeScript.
        Additionally, my experience as an ecommerce manager for one of the
      ...
      <p>
        ...
        into tangible results. Looking forward, my professional goals include
        transitioning successfully into the tech industry, continuous learning,
      ...
      <p>
        ...
        tech realm, I find joy in numismatics, strumming my guitar, exploring
        robotics, and indulging in survival camping adventures.
      </p>
    </>
  );
};
